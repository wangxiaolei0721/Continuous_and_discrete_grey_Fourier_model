...
title('(a) Mean$_\mathrm{GFM}$($\mathrm{MAE}_{F}$) $-$ Mean$_\mathrm{DGFM}$($\mathrm{MAE}_{F}$)','interpreter','latex')
...
yline(0,'--','HandleVisibility','off')
title('(b) Mean$_\mathrm{GFM}$($\mathrm{MAE}_{T}$) $-$ Mean$_\mathrm{DGFM}$($\mathrm{MAE}_{T}$)','interpreter','latex')
xlabel('Fourier order')
set(gca,'FontName','Book Antiqua','FontSize',12 ,'Xlim',[-0.5,6.5])
subplot(2,2,3)
plot(order,di_var_fit','LineWidth',1,"Marker","o")
yline(0,'--','HandleVisibility','off')
title('(c) Var$_\mathrm{GFM}$($\mathrm{MAE}_{F}$) $-$ Var$_\mathrm{GFM}$($\mathrm{MAE}_{F}$)','interpreter','latex')
xlabel('Fourier order')
set(gca,'FontName','Book Antiqua','FontSize',12 ,'Xlim',[-0.5,6.5])
subplot(2,2,4)
plot(order,di_var_tra','LineWidth',1,"Marker","o")
yline(0,'--','HandleVisibility','off')
title('(d) Var$_\mathrm{GFM}$($\mathrm{MAE}_{T}$) $-$ Var$_\mathrm{GFM}$($\mathrm{MAE}_{T}$)','interpreter','latex')
xlabel('Fourier order')
set(gca,'FontName','Book Antiqua','FontSize',12,'Xlim',[-0.5,6.5])
%% save figure
